...
struct Cli {
    ...
    #[arg(
        long,
        help = "Check contents of files to detect script with shebangs for nu"
    )]
    ...
    let nu_files = valid_paths
        ...
        .flat_map(|path| {
            ...
            builder
                ...
                .filter(|entry| is_nu_file(entry, check_for_shebang))
